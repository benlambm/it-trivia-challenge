        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 py-3 px-5 rounded-2xl bg-[#E87722] text-white font-black border-4 border-[#173A45] transition-all transform hover:-translate-y-1 hover:bg-[#D63A4C] hover:shadow-[4px_4px_0px_0px_#E87722] active:translate-y-0 active:shadow-none"
            >
